...
const id = ["726375049166192660","983424476123377694"];//Put Owners Ids
var chs = ["1026112654416285787","","","",""];//Put Shop Channels Ids
var line = 'https://cdn.discordapp.com/attachments/1027552852811452487/1027957064284246036/983424476123377694.gif';//Put Your Line
const orderschannel = "1027936913828630599";//Put Order Channel Id
const selersroleid = "1026118526118940692";//Put Seller Role Id
...
///////////Bad - بدرو
  ...
  client.user.setStatus("online");///////////Bad - بدرو
    client.user.setActivity("BOT SHOP");///////////Bad - بدرو
});///////////Bad - بدرو
///////////Bad - بدرو
...
chs.forEach((aChannel) => {
    var rr = message.guild.roles.everyone.id;
client.channels.cache.get(aChannel).createOverwrite(rr,{
...
.setTimestamp();
  ...
  if(message.content.toLowerCase().startsWith(prefix + "renew")) {
    ...
    .setTitle(`**${prefix}renew user channel time**\n**${prefix}renew الوقت الروم شخص**`)
    .setAuthor(`❔ Usage`, client.user.displayAvatarURL({dynamic : true}))
      .setDescription(`
\`User\` : **(Mention)** Preson who send messages in the channel
\`شـخـص\` : **(منشن)** الشخص الذي رح يرسل الرسائل في الروم
